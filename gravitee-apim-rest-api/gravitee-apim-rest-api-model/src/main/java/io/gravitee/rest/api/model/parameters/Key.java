...
public enum Key {
    ...
    PORTAL_NEXT_BANNER_CONFIG_TITLE("portal.next.banner.config.title", "Welcome to Gravitee Developer Portal!", new HashSet<>(singletonList(ENVIRONMENT))),
    PORTAL_NEXT_BANNER_CONFIG_SUBTITLE("portal.next.banner.config.subtitle", "Discover powerful APIs to supercharge your projects.", new HashSet<>(singletonList(ENVIRONMENT))),
    PORTAL_NEXT_BANNER_CONFIG_ENABLED("portal.next.banner.config.enabled", "true", new HashSet<>(singletonList(ENVIRONMENT))),
