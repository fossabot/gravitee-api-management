...
public enum Key {
    ...
    PORTAL_NEXT_BANNER_TITLE("portal.next.banner.title", "Welcome to Gravitee Developer Portal!", new HashSet<>(singletonList(ENVIRONMENT))),
    PORTAL_NEXT_BANNER_SUBTITLE("portal.next.banner.subtitle", "Discover powerful APIs to supercharge your projects.", new HashSet<>(singletonList(ENVIRONMENT))),
    PORTAL_NEXT_BANNER_ENABLED("portal.next.banner.enabled", "true", new HashSet<>(singletonList(ENVIRONMENT))),
