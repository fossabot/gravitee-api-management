...
@Component({
  selector: 'api-documentation-v4-home-page-element',
  templateUrl: './api-documentation-v4-home-page-element.component.html',
  styleUrls: ['./api-documentation-v4-home-page-element.component.scss'],
})
export class ApiDocumentationV4HomePageElementComponent implements OnInit, OnChanges {
  @Input()
  page: Page;
  ...
  ngOnChanges(changes: SimpleChanges): void {
    if (changes.pages) {
      this.dataSource = new MatTableDataSource<Page>([this.page]);
      this.ngOnInit();
    }
  }
